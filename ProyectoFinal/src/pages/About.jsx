    ...
    <div className="min-h-screen bg-gray-100 flex flex-col items-center">
      <main className="container mx-auto p-8 text-center">
        <section className="mb-12">
          <h2 className="text-6xl font-bold mb-8 text-gray-800">Sobre TutorLabs</h2>
          ...
          <img 
            src={educacion} 
            alt="Educación" 
            className="rounded-lg shadow-lg mb-12 mx-auto"
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h3 className="text-4xl font-bold mb-6 text-gray-800">Nuestra Misión</h3>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h3 className="text-4xl font-bold mb-6 text-gray-800">Nuestros Tutores</h3>
            <p className="text-lg mb-6 text-gray-600">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h3 className="text-4xl font-bold mb-6 text-gray-800">Nuestros Estudiantes</h3>
            <p className="text-lg mb-6 text-gray-600">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h3 className="text-4xl font-bold mb-6 text-gray-800">Nuestros Valores</h3>
            <p className="text-lg mb-6 text-gray-600">
