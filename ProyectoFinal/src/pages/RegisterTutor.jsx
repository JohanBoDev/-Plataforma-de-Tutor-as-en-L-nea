      ...
      <form onSubmit={handleSubmit} className="bg-white p-10 rounded shadow-lg w-full max-w-4xl flex flex-col items-center mt-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full">
          ...
          <div className="flex flex-col items-start gap-y-2">
            ...
            <input type="text" id="puesto" name="puesto" value={form.puesto} onChange={handleChange} className="border border-black rounded pl-5 w-[400px] h-10" />
          </div>
          <div className="flex flex-col items-start gap-y-2">
          ...
          <div className="flex flex-col items-start gap-y-2">
            ...
            <select id="nivel_educativo" name="nivel_educativo" value={form.nivel_educativo} onChange={handleChange} className="border border-black rounded pl-5 w-[400px] h-10">
        ...
        {showExperience && (
          <div className="grid grid-cols-2 gap-5 w-full mt-10" id="xp-tutor">
